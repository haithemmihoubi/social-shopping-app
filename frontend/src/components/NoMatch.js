...
export default function NoMatch() {
  ...
  return (
    ...
    style={{background: 'linear-gradient(90deg, rgba(255,37,51,1) 0%, rgba(255,54,129,1) 100%)'}}>
      <motion.svg
        variants={variant}
        initial="hidden"
        animate="show"
